...
public class Administrador {
	...
	public Administrador(Servidor servidor) {
		...
		this.googleId = servidor.getGoogleId();
		this.imagemPerfilUri = servidor.getImagemPerfilUri();
		this.permissaoDeAcessoProfissionalDeSaude = servidor.getPermissaoDeAcessoProfissionalDeSaude();
		this.permissaoDeAcessoPsicologo = servidor.getPermissaoDeAcessoPsicologo();
	}
