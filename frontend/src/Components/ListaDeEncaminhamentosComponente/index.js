...
export default function ListaDeEncaminhamentosComponente(props) {
    ...
    const allEncaminhamentos = () => {
            ...
            EncaminhamentoService.getAllEncaminhamento().then((response) => {
                setEncaminhamentos(response.data)
            });
        
        // else {
        //     EncaminhamentoService.getEncaminhamentosByIdProfSaude(id).then((response) => {// pensar na forma como os encaminhamentos ocorrerão . consultar as anotaçoes 
        //         setEncaminhamentos(response.data)
        //     });
        // }
    };
