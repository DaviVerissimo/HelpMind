        ...
        <div> <ToobarProfissionalDeSaude></ToobarProfissionalDeSaude>
            <div >
                ...
                <Card subTitle='REPORTADOR POR' >
                    <InputText value={NomeReportante} onChange={(e) => setNome(e.target.value)} />
                </Card>
                ...
                <Card >
                    ...
                    <Card subTitle='CAMPUS' >
                        <InputText value={campus} onChange={(e) => setCampus(e.value)} />
                    </Card>
                    <Card subTitle='CURSO' >
                        <InputText value={curso} onChange={(e) => setCurso(e.value)} />
                    </Card>
                    <Card subTitle='ANO / PERÍODO' >
                        <InputText value={periodo} onChange={(e) => setPeriodos(e.target.value)} />
                    </Card>
                    <Card subTitle='JÁ TENTOU SUICÍDIO?' >
                        <InputText optionLabel="name" value={suicidio} onChange={(e) => setSuicidio(e.target.value)} />
                    </Card>
