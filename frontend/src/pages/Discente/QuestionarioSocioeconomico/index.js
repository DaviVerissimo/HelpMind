    ...
    return (
        <div>
            ...
            <div>
                ...
                <Card subTitle='NOME' >
                    <InputText className={nomeObrigatorio} value={nome} onChange={(e) => setNome(e.target.value)} placeholder="Digite seu nome" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='MATRICULA' >
                    <InputText className={matriculaObrigatoria} value={matricula} onChange={(e) => setMatricula(e.target.value)} placeholder="Digite sua matricula" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='CAMPUS' >
                    <Dropdown className={campusObrigatorio} filter value={campusDoDiscente} options={campi} onChange={(e) => setCampusDoDiscente(e.value)} placeholder="Escolha um campus" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='CURSO' >
                    <Dropdown className={cursoObrigatorio} filter value={curso} options={cursos} onChange={(e) => setCurso(e.value)} placeholder="Escolha um curso" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='PERIODO' >
                    <Dropdown className={periodoObrigatorio} filter optionLabel="name" value={periodo} options={periodos} onChange={(e) => setPeriodo(e.target.value)} placeholder="Escolha um periodo" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='IDADE' >
                    <Dropdown className={idadeObrigatoria} filter optionLabel="name" value={idade} options={idades} onChange={(e) => setIdade(e.target.value)} placeholder="Escolha uma idade" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='CIDADE' >
                    <Dropdown className={cidadeObrigatoria} filter optionLabel="name" value={cidade} options={cidades} onChange={(e) => setCidade(e.target.value)} placeholder="Escolha uma cidade" style={{ width: '100%' }} />
                ...
                <Card subTitle='ESTADO CIVIL' >
                    <Dropdown className={estadoCivilObrigatorio} filter optionLabel="name" value={estadoCivil} options={estadosCivis} onChange={(e) => setEstadoCivil(e.target.value)} placeholder="Escolha seu estado civil" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='COM QUEM VIVE' >
                    <Dropdown className={comQuemViveObrigatoria} filter optionLabel="name" value={comQuemVive} options={comQuemVives} onChange={(e) => setComQuemVive(e.target.value)} placeholder="Escolha com quem vive" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='RENDA FAMILIAR' >
                    <Dropdown className={rendaFamiliarObrigatoria} filter optionLabel="name" value={rendaFamiliar} options={rendasFamiliar} onChange={(e) => setRendaFamiliar(e.target.value)} placeholder="Escolha uma renda" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='COR' >
                    <Dropdown className={corObrigatoria} filter optionLabel="name" value={cor} options={cores} onChange={(e) => setCor(e.target.value)} placeholder="Escolha sua cor" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='GÊNERO' >
                    <Dropdown className={generoObrigatoria} filter optionLabel="name" value={genero} options={generos} onChange={(e) => setGenero(e.target.value)} placeholder="Escolha seu gênero" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='OPTANTE/ INGRESSANTE POR VAGAS DE COTAS?' >
                    <Dropdown className={ingressantePorVagaDeCotaObrigatoria} filter optionLabel="name" value={ingressantePorVagaDeCota} options={cotas} onChange={(e) => setIngressantePorVagaDeCota(e.target.value)} placeholder="Optou pelas cotas?" style={{ width: '100%' }} />
                ...
                <Card subTitle='É PESSOA COM DEFICIÊNCIA?'  >
                    <Dropdown className={pessoaDeficienteObrigatoria} filter optionLabel="name" value={pessoaDeficiente} options={deficiencias} onChange={(e) => setPessoaDeficiente(e.target.value)} placeholder="Possui algum tipo de deficiência:" style={{ width: '100%' }} />
                    <Card className='p-mt-3' subTitle='Em caso de resposta afirmativa especifique:' >
                ...
                <Card subTitle='FAZ USO DE BEBIDA ALCOÓLICA'>
                    <Dropdown className={usoBebidaAlcoolicaObrigatoria} filter optionLabel="name" value={usoBebidaAlcoolica} options={bebidasAlcoolica} onChange={(e) => setUsoBebidaAlcoolica(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='VOCÊ JÁ SOFREU OU SOFRE BULLYING NA ESCOLA?' >
                    <Dropdown className={bullyngObrigatoria} filter optionLabel="name" value={bullyng} options={bullyngs} onChange={(e) => setBullyng(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='ALGUÉM NA SUA RESIDÊNCIA SOFRE COM ALGUM PROBLEMA DE SAÚDE MENTAL?' >
                    <Dropdown className={resideComPortadorDeProblemaMentalObrigatoria} filter optionLabel="name" value={resideComPortadorDeProblemaMental} options={residentesSofrimentoMental} onChange={(e) => setResideComPortadorDeProblemaMental(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='VOCÊ SOFRE DE ALGUM PROBLEMA DE SAÚDE MENTAL?' >
                    <Dropdown className={discenteSofrimentoMentalObrigatoria} filter optionLabel="name" value={discenteSofrimentoMental} options={discenteSofrimentosMental} onChange={(e) => setDiscenteSofrimentoMental(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                ...
                <Card subTitle='JÁ FEZ USO DE PSICOTRÓPICO: ANSIEDADE OU DEPRESSÃO?' >
                    <Dropdown className={psicotropicoObrigatoria} filter optionLabel="name" value={psicotropico} options={psicotropicos} onChange={(e) => setPsicotropico(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='EM ALGUM MOMENTO DA VIDA MANIFESTOU INTERESSE EM PROCURAR AJUDA PSICÓLOGO?' >
                    <Dropdown className={interesseAjudaPsicologicaObrigatoria} filter optionLabel="name" value={interesseAjudaPsicologica} options={interessesAjudaPsicologica} onChange={(e) => setInteresseAjudaPsicologica(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                </Card>
                <Card subTitle='VOCÊ É BENEFICIADO COM ALGUM BOLSA OU PROGRAMA DE ASSISTÊNCIA ESTUDANTIL IFPB' >
                    <Dropdown className={beneficioObrigatoria} filter optionLabel="name" value={beneficio} options={beneficios} onChange={(e) => setBeneficio(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                ...
                <Card subTitle='O DOMICÍLIO DO GRUPO FAMILIAR É' >
                    <Dropdown className={domicilioObrigatoria} filter optionLabel="name" value={domicilio} options={domicilios} onChange={(e) => setDomicilio(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                    <Card className='p-mt-3' subTitle='Informe a quantidade de cômodos:' >
                        <InputText className={quantidadeComodos_opObrigatoria} value={quantidadeComodos_op} onChange={(e) => setQuantidadeComodos_op(e.target.value)} placeholder="Cômodos" style={{ width: '100%' }} />
                    </Card>
                </Card>
                <Card subTitle='VOCÊ APRESENTA ALGUMA DOENÇA GRAVE?' >
                    <Dropdown className={temDoencaObrigatoria} filter optionLabel="name" value={temDoenca} options={DiscenteDoencas} onChange={(e) => setTemDoenca(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                    <Card className='p-mt-3' subTitle='Em caso de resposta afirmativa, especifique:' >
                ...
                <Card subTitle='ALGUÉM DO SEU NÚCLEO FAMILIAR APRESENTA DOENÇA GRAVE?' >
                    <Dropdown className={possuiFamiliarComDoencaGraveObrigatoria} filter optionLabel="name" value={possuiFamiliarComDoencaGrave} options={doencasParente} onChange={(e) => setPossuiFamiliarComDoencaGrave(e.target.value)} placeholder="Escolha uma opção" style={{ width: '100%' }} />
                    <Card className='p-mt-3' subTitle='Em caso de resposta afirmativa, especifique:' >
                        <InputText className='p-mr-3' value={familiarDoente} onChange={(e) => setFamiliarDoente(e.target.value)} placeholder="Seu parente" />
                        <InputText className=' p-mt-3' value={doencaDoFamiliar_op} onChange={(e) => setDoencaDoFamiliar_op(e.target.value)} placeholder="A doença do seu parente" style={{ width: '100%' }} />
                    </Card>
                </Card>
            </div>
        </div>
