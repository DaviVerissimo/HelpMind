...
export default function QuestionarioDeDepresaoDeBeck() {
    ...
    async function submeter() {
        ...
        if (checked === true) {
            ...
            axios.post("http://localhost:8080/QuestionarioDeDepressaoDeBeck/salvar", questoesRespondidas, headers)
                .then(Response => { })
            ...
            <Toast ref={toast} />
                ...
                <Card subTitle='QUESTÂO 19' >
                    ...
                    <Card subTitle='Estou tentando perder peso de propósito, comendo menos' >
                        {/* Definir junto ao cliente se os campos abaixo anulam o peso da questao 19 */}
