    ...
    const leftContentsMobile = (
        <React.Fragment>
            <div className='' style={{ padding: '1em' }}>
                ...
                <Button icon={createIcon("pi pi-comments")} className="p-button-outlined p-button-lg p-mr-3 p-col p-mt-3" label='Contatos' />
                <Button icon={createIcon("pi pi-file-o")} className="p-button-outlined p-button-lg p-mr-3 p-col p-mt-3" label='Inventario' onClick={() => { history.push('/discente/EscolherQuestionariosDiscente') }} />
                <Button icon={createIcon("pi pi-bell")} className="p-button-outlined p-button-lg p-mr-3 p-col p-mt-3 " label='Reportes' onClick={() => { history.push('/discente/Reportes') }} />
                <Button icon={createIcon("pi pi-user")} className="p-button-outlined p-button-lg p-mr-3 p-col  p-mt-3" label='Discente' onClick={() => { history.push('/discente/Perfil') }} />
            </div>
        </React.Fragment>
    );
