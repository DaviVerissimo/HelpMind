        ...
        <React.Fragment>
            <div className='p-grid p-col' style={{ padding: '1em' }}>
                ...
                <Button
                    ...
                    label='Home'
                    onClick={() => { history.push('/Discente/home') }}
                />
                <Button
                    icon={createIcon("pi pi-box")}
                    className="p-button-outlined p-button-lg  p-mr-3 p-col"
                    label='Materiais online'
                    onClick={() => { history.push('/Discente/MateriaisOnline') }}
                />
                ...
                <Button
                    ...
                    className="p-button-outlined p-button-lg  p-mr-3 p-col"
                    label='Quem Somos'
                    onClick={() => { history.push('/Discente/quemSomos') }}
                />
                <Button
                    icon={createIcon("pi pi-comments")}
                    className="p-button-outlined p-button-lg p-mr-3 p-col"
                    label='Contatos'
                    onClick={() => { history.push('/Discente/Contatos') }}
                />
                <Button
                    icon={createIcon("pi pi-file-o")}
                    className="p-button-outlined p-button-lg p-mr-3 p-col"
                ...
                <Button
                    ...
                    className="p-button-outlined p-button-lg p-mr-3 p-col"
                    label='Discente'
                    onClick={() => { history.push('/discente/Perfil') }}
                />
            </div>
        </React.Fragment>
    );
        ...
        <React.Fragment>
            <div>
                ...
                <Button
                    icon={createIcon("pi pi-user")}
                    style={{ width: '100%' }}
                    className="p-button-outlined p-button-lg p-mr-3 p-mt-3 p-mb-3"
                    label='Discente'
                    onClick={() => { history.push('/discente/Perfil') }}
                />
                <FotoPerfil></FotoPerfil>
